...
import com.payment.payment_system.captcha.ICaptchaService;
...
public class RegistrationCaptchaController {
    ...
    @Autowired
    public RegistrationCaptchaController(UserService userService, ICaptchaService captchaService, ApplicationEventPublisher eventPublisher) {
        super();
