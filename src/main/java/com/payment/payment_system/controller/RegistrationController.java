...
import com.payment.payment_system.domain.Privilege;
import com.payment.payment_system.domain.Role;
...
import com.payment.payment_system.security.ISecurityUserService;
import com.payment.payment_system.service.UserService;
import com.payment.payment_system.web.dto.PasswordDto;
import com.payment.payment_system.web.dto.UserDto;
import com.payment.payment_system.web.exceptions.InvalidOldPasswordException;
import com.payment.payment_system.web.util.GenericResponse;
...
public class RegistrationController {
    ...
    @Autowired
    public RegistrationController(UserService userService, ISecurityUserService securityUserService,
                                  MessageSource messages, JavaMailSender mailSender, ApplicationEventPublisher eventPublisher,
    ...
    private SimpleMailMessage constructResendVerificationTokenEmail(final String contextPath, final Locale locale, final Token newToken, final User user) {
